             ...
             <div className="bg-white border-4 border-black p-6">
               ...
               <div className="space-y-4">
                 ...
                 <div className="flex gap-4">
                   <div className="flex-1"><label className="block text-[10px] font-black uppercase tracking-widest mb-1">Execution Date</label><input type="date" value={taskForm.dueDate} onChange={e => setTaskForm({...taskForm, dueDate: e.target.value})} className="w-full h-12 bg-neutral-100 border-2 border-black p-2 font-mono text-sm"/></div>
        ...
        <div className="fixed inset-0 bg-black/90 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
           <div className="bg-white w-full max-w-md border-4 border-black p-6">
             ...
             <div className="space-y-4">
                ...
                <div className="flex gap-4">
                    <div className="flex-1"><label className="block text-[10px] font-black uppercase tracking-widest mb-1">Cost</label><input type="number" value={subForm.cost} onChange={e => setSubForm({...subForm, cost: parseFloat(e.target.value) || 0})} placeholder="0.00" className="w-full h-12 border-2 border-black p-3 font-bold"/></div>
                    <div className="flex-1"><label className="block text-[10px] font-black uppercase tracking-widest mb-1">Cycle</label><select value={subForm.cycle} onChange={e => setSubForm({...subForm, cycle: e.target.value as any})} className="w-full h-12 border-2 border-black p-3 font-bold uppercase"><option value="monthly">Monthly</option><option value="quarterly">Quarterly (4mo)</option><option value="biannual">Biannual (6mo)</option><option value="yearly">Yearly</option><option value="custom">Custom</option></select></div>
                </div>
